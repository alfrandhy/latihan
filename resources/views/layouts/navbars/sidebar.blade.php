  ...
  -->
    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            <li
                ...
                <div class="collapse show" id="laravelExample">
                    <ul class="nav">
                        ...
                        <li
                            class="nav-item{{ $activePage == 'user-management' ? ' active' : '' }}">
            ...
            <li
                class="nav-item{{ $activePage == 'table' ? ' active' : '' }}">
            ...
            <li
                class="nav-item{{ $activePage == 'typography' ? ' active' : '' }}">
            ...
            <li
                class="nav-item{{ $activePage == 'icons' ? ' active' : '' }}">
